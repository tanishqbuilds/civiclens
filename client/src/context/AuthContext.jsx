...
export function AuthProvider({ children }) {
    ...
    // User state (citizen / officer role-based auth)
    ...
    // User login (citizen / officer)
    const userLoginFn = useCallback(async (loginData) => {
        const { data } = await apiUserLogin(loginData);
        localStorage.setItem('user_token', data.token);
        setUser(data.user);
        return data;
    }, []);
